...
const options = [
  { id: "main_income", label: "To earn my main income", image: "💰" },
  { id: "side_money", label: "To make money on the side", image: "💵" },
  { id: "experience", label: "To get experience, for a full-time job", image: "🏅" },
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 h-[62dvh]">
      ...
      <p className="text-sm text-gray-500 mt-1">
        Different people come to Upwork for various reasons. We want to highlight
        the opportunities that fit your goals best while still showing you all the
        possibilities.
      </p>
        ...
        {options.map((option) => (
          <div
            ...
            className={`border rounded-lg p-4 flex flex-col items-center cursor-pointer transition duration-200 ${
              userDetails.freelancingGoal === option.label
