  ...
  return (
    ...
    <div className="flex justify-center items-center h-[78dvh] px-6">
      <div className="bg-white p-8 rounded-lg shadow-lg  w-1/2 flex items-center flex-col mx-auto mt-10">
        <h2 className="text-3xl font-semibold mb-4">Hey Jadeja. Ready for your next big opportunity?</h2>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-[35vw] mx-auto  w-full relative">
        <Slider {...settings}>
